"""
Django settings for SaborWeb project.
...
SECRET_KEY = 'django-insecure-&@sq)8hz*m-*s=t3*i#2-o9#^ynhlua@)$8z_-ki6x^-yhbhsi'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
#GLOBAL_IP = '192.168.0.109'
#GLOBAL_HOST = '3000'
ALLOWED_HOSTS = []
...
WSGI_APPLICATION = 'SaborWeb.wsgi.application'
